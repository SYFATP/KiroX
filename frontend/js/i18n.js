  ...
  var DICT = {
    zh: {
      ...
      settings: {
        ...
        webPasswordTitle: 'Web 登录密码',
        webPasswordDesc: '保存到 storage.conf；用于 Web 模式访问密码，修改后下次启动生效',
        webPasswordUnknown: '当前状态：读取中',
        webPasswordConfigured: '当前状态：已配置登录密码',
        webPasswordNotConfigured: '当前状态：未配置登录密码',
        webPasswordPlaceholder: '留空并保存=清空密码',
        webPasswordClear: '清空密码',
        webPasswordSaved: 'Web 登录密码已保存，重启 Web 服务后生效',
        webPasswordCleared: 'Web 登录密码已清空，重启 Web 服务后生效',
    ...
    en: {
      ...
      settings: {
        ...
        webPasswordTitle: 'Web login password',
        webPasswordDesc: 'Saved to storage.conf; used by Web mode, takes effect after restart',
        webPasswordUnknown: 'Status: loading',
        webPasswordConfigured: 'Status: password configured',
        webPasswordNotConfigured: 'Status: no password configured',
        webPasswordPlaceholder: 'Save empty value to clear password',
        webPasswordClear: 'Clear password',
        webPasswordSaved: 'Web login password saved; restart Web service to apply',
        webPasswordCleared: 'Web login password cleared; restart Web service to apply',
    ...
    ja: {
      ...
      settings: {
        ...
        webPasswordTitle: 'Web ログインパスワード',
        webPasswordDesc: 'storage.conf に保存されます。Web モードのアクセスパスワードで、再起動後に有効になります',
        webPasswordUnknown: '状態：読み込み中',
        webPasswordConfigured: '状態：ログインパスワード設定済み',
        webPasswordNotConfigured: '状態：ログインパスワード未設定',
        webPasswordPlaceholder: '空で保存するとパスワードをクリア',
        webPasswordClear: 'パスワードをクリア',
        webPasswordSaved: 'Web ログインパスワードを保存しました。Web サービス再起動後に有効になります',
        webPasswordCleared: 'Web ログインパスワードをクリアしました。Web サービス再起動後に有効になります',
